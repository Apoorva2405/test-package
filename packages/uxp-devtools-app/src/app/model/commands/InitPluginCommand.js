...
const templates = {
    psStarterMod: {
        name: "ps-starter",
        value: require("@apoorva2405/uxp-template-ps-starter")
    },
    defaultPsStarterMod : {
        name: "default-starter-ps",
        value: require("@apoorva2405/uxp-template-default-starter-ps")
    },
    reactStarterMod : {
        name: "ps-react-starter",
        value: require("@apoorva2405/uxp-template-ps-react-starter")
    },
    reactTypescriptMod : {
        name: "ps-react-typescript",
        value: require("@apoorva2405/uxp-template-ps-react-typescript")
    },
    xdStarterMod : {
        name: "xd-starter",
        value: require("@apoorva2405/uxp-template-xd-starter")
    },
    defaultXdStarterMod : {
        name: "default-starter-xd",
        value: require("@apoorva2405/uxp-template-default-starter-xd")
    },
};
